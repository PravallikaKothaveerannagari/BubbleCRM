...
def get_account_id(access_token,unique_identifier,field_name):
    ...
    params = {
        'criteria': f'{field_name}:equals:{unique_identifier}'
    }
...
def update_lead(access_token,payload):
    url = f"https://www.zohoapis.ca/crm/v2/Leads"
    headers = {
        "Authorization": f"Zoho-oauthtoken {access_token}",
        "Content-Type": "application/json",
    }
